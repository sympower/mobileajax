...
public class MobileAjaxPanelVisual extends JPanel implements DocumentListener {
    
    public static final String PROP_PROJECT_NAME = "projectName";
    
    private MobileAjaxWizardPanel panel;
    
    /** Creates new form PanelProjectLocationVisual */
    public MobileAjaxPanelVisual(MobileAjaxWizardPanel panel) {
        initComponents();
        this.panel = panel;
